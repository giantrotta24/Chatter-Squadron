...
class GatsbyReporter extends _react.default.Component {
  ...
  render() {
    ...
    return _react.default.createElement(_ink.Box, {
      ...
      flexDirection: "column"
    }, _react.default.createElement(_ink.Static, null, messages.map((msg, index) => _react.default.createElement(_ink.Box, {
      textWrap: "wrap",
      key: index
    }, _react.default.createElement(_messages.Message, {
      type: msg.type,
      hideColors: disableColors
    }, msg.text)))), spinners.map(activity => _react.default.createElement(_spinner.default, (0, _extends2.default)({
      key: activity.id,
      name: activity.id
