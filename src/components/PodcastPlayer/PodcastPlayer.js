  ...
  return (
    ...
    <div className='container my-4'>
      <iframe 
        ...
        msallowfullscreen
      />
      <iframe src="https://open.spotify.com/embed-podcast/episode/65mMmsN1KC9dx8MfJrWG4o" width="100%" height="232" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
    </div>
    );
};
